...
class BaseError(Exception):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        error_dict = {"error": self.error_code, "message": self.message}
        if self.details:
...
class AuthenticationError(BaseError):
    ...
    def __init__(self, message: str = "Authentication required"):
        super().__init__(
            message=message, error_code="AUTHENTICATION_ERROR", http_status=401
        )
...
class InvalidEmailError(ValidationError):
    ...
    def __init__(self, email: str):
        super().__init__(message="Invalid email format", field="email", value=email)
...
class InvalidCredentialsError(CognitoError):
    ...
    def __init__(self):
        super().__init__(message="Invalid email or password", operation="login")
...
class InvalidConfirmationCodeError(CognitoError):
    ...
    def __init__(self):
        super().__init__(
            message="Invalid confirmation code", operation="confirm_signup"
        )
        self.http_status = 400
