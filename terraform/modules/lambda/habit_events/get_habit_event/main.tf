...
resource "aws_lambda_function" "this" {
  ...
  handler       = "handlers.habit_events.${local.handler_path}.lambda_handler"
  runtime       = var.runtime
...
resource "aws_lambda_permission" "allow_apigw" {
  statement_id  = "AllowAPIGatewayInvokeGetHabitEvent"
...
resource "aws_apigatewayv2_route" "this" {
  api_id    = var.api_id
  route_key = "GET /households/{householdId}/subjects/{subjectId}/habits/{habitId}/events/{periodKey}"
