...
resource "aws_lambda_function" "this" {
  ...
  handler       = "handlers.household_subjects.${local.handler_path}.lambda_handler"
  runtime       = var.runtime
...
resource "aws_lambda_permission" "allow_apigw" {
  statement_id  = "AllowAPIGatewayInvokeDeleteSubject"
...
resource "aws_apigatewayv2_route" "this" {
  api_id    = var.api_id
  route_key = "DELETE /households/{householdId}/subjects/{subjectId}"
