...
LAMBDAS = create-todo get-todo get-all-todo update-todo delete-todo create-habit get-habit get-all-habit update-habit signup login create-user-profile get-user-profile
