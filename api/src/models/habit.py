...
from src.models.enum import DifficultyLevelEnum, CounterOptionEnum, StatusEnum
...
class HabitEventsSchemaRequest(DataClassJsonMixin):
    habit_id: int
    reset_counter: EnumField(CounterOptionEnum, by_value=True)  # type: ignore
...
class HabitEventsTable(BASE):
    ...
    reset_counter = Column(Enum(CounterOptionEnum))
...
class HabitSchemaRequest(DataClassJsonMixin):
    ...
    counter_option: EnumField(CounterOptionEnum, by_value=True)  # type: ignore
    status: EnumField(StatusEnum, by_value=True)  # type: ignore
    note: str = None
...
class HabitTable(BASE):
    ...
    counter_option = Column(Enum(CounterOptionEnum))
